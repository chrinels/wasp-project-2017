...
odcore::data::dmcp::ModuleExitCodeMessage::ModuleExitCode VehicleSim::body()
{
  ...
  while (getModuleStateAndWaitForRemainingTimeInTimeslice() == odcore::data::dmcp::ModuleStateMessage::RUNNING) {
...

    {
      ...
      std::cout << "vx " << std::to_string(vx) << std::endl;
      ...
      std::cout << "vxf " << std::to_string(vxf) << std::endl;
      ...
      std::cout << "FX " << std::to_string(FX) << std::endl;
      ...
      auto dr = MZ/Izz;
      std::cout << "dvx " << std::to_string(dvx) << std::endl;
